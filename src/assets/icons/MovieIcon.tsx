...
const MovieIcon = (props: any) => {
  ...
  return (
    <svg
      ...
      // height="492.081px"
      className={className}
      viewBox="0 0 492.082 492.081" /* style="enable-background:new 0 0 492.082 492.081;" */
    >
      <g>
        <g>
          <path
            d="M85.312,262.951h263.064V127.414c12.289-13.529,19.779-31.498,19.779-51.215C368.155,34.115,334.04,0,291.957,0
          ...
          />
          <path
            d="M232.353,271.6h-32.099L84.42,452.654c-4.05,6.332-2.2,14.746,4.13,18.797c2.271,1.451,4.81,2.146,7.32,2.146
